...
import com.android.nnbppratical.adapter.ListUserAdapter;
import com.android.nnbppratical.database.AppDatabase;
import com.android.nnbppratical.entity.UserEntity;
import com.android.nnbppratical.event.MessageEvent;
    ...
    private void setBtnReset() {
        btnReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                db.userDao().getAllUser().size();
                Toast.makeText(ListActivity.this, "Số bản ghi được thực hiện " + db.userDao().getAllUser().size(), Toast.LENGTH_SHORT).show();
